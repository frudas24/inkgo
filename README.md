...
```bash
go get github.com/frudas24/inkgo@v0.1.23
```

The latest published release is `v0.1.23`. Development checkouts may contain entries under `Unreleased`; consumers that need reproducible builds should pin a published tag or an explicit commit.
