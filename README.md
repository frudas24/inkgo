...
The source version is `v0.1.5`. The Git tag is the authoritative published version; until that tag is published, consumers of a development checkout can use a local `replace` directive or the repository branch they intentionally pin.
...
- [`docs/RELEASE.md`](docs/RELEASE.md) — `v0.1.5` publication checklist and repository metadata
