...
The project is stdlib-only, CGO-free, importable as `github.com/frudas24/inkgo`, and `v0.1.16` is publicly tagged. Development checkouts may contain additional `Unreleased` hardening.
