...
The latest published release is **v0.1.20**. This document is the checklist for
...
version (for example `v0.1.20`) and create an annotated tag:

```bash
git tag -a v0.1.20 -m "inkgo v0.1.20"
...
```bash
go list -m github.com/frudas24/inkgo@v0.1.20
go get github.com/frudas24/inkgo@v0.1.20
```
